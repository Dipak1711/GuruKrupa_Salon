/**
 * GURUKRUPA SALON — SEED DATA EXPORTER & SQL UTILITY
 * 
 * This file contains preserved demo records converted into standard SQL INSERT
 * statements. Run these queries in your Supabase SQL Editor to populate test data.
 * 
 * NOTE: This file is NOT imported in production application code.
 */

export const SUPABASE_SEED_SQL = `
-- ==============================================================================
-- GURUKRUPA SALON — FULL SEED SCRIPT FOR SUPABASE
-- Execute in Supabase Dashboard > SQL Editor after running schema.sql
-- ==============================================================================
...
INSERT INTO gallery (title, image_url, category, description, status)
VALUES 
    ('Bespoke Textured Fade & Beard Alignment', 'https://images.unsplash.com/photo-1622286342621-4bd786c2447c?auto=format&fit=crop&w=800&q=80', 'Hair & Beard', 'Master razor contouring and matte pomade finish by Rahul Sharma.', 'active'),
    ('24K Gold Luxury Skin Hydration', 'https://images.unsplash.com/photo-1570172619644-dfd03ed5d881?auto=format&fit=crop&w=800&q=80', 'Facial & Skin', 'Ultrasonic deep pore cleansing followed by pure gold peptide infusion.', 'active'),
    ('Royal Groom Makeover Suite', 'https://images.unsplash.com/photo-1583391733956-3750e0ff4e8b?auto=format&fit=crop&w=800&q=80', 'Groom Special', 'Head-to-toe royal pampering with herbal scrub, hair nourishment & beard architecture.', 'active'),
    ('Intense Keratin Hair Rebirth', 'https://images.unsplash.com/photo-1527799820374-dcf8d9d4a388?auto=format&fit=crop&w=800&q=80', 'Hair Therapy', 'Organic moroccan argan oil steam press therapy.', 'active');
`;
